...
import com.betharley.mobile.portfolioapp.comentarios.ComentarioActivity;
...
public class DetalhesActivity extends AppCompatActivity {
    ...
    private void setData() {
        ...
        Glide.with( getApplicationContext() ).load( portfolioItem.getUrl() ).placeholder( R.drawable.image_padrao ).into( imagem );
    }
                    ...
                    likesRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if( dataSnapshot.exists() ){
                                ...
                                FirebaseDatabase.getInstance().getReference()
                                        .child("Likes").child( portfolioItem.getKey() )
